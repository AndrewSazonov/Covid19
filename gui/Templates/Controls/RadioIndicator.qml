...
Rectangle {
    ...
    implicitWidth: Globals.Sizes.fontInPixels
    implicitHeight: Globals.Sizes.fontInPixels

    radius: width / 2

    color: "transparent"
    border.width: Globals.Sizes.fontInPixels / 8
    ...
    */
    ...
    Rectangle {
        ...
        width: Globals.Sizes.fontInPixels * 0.6
        height: Globals.Sizes.fontInPixels * 0.6
