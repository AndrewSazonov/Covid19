...
T.RadioButton {
    ...
    padding: Globals.Sizes.fontInPixels * 0.5
    verticalPadding: padding + Globals.Sizes.fontInPixels * 0.5
    ...
    contentItem: Text {
        leftPadding: control.indicator && !control.mirrored ? control.indicator.width + control.spacing - Globals.Sizes.fontInPixels * 0.2 : 0
